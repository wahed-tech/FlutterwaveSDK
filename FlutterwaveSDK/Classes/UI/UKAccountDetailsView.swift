...
class UKAccountDetailsView: UIView {
    ...
    lazy var titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Please complete this transaction on your Mobile Banking App or Online Banking platform using the following details:"
    ...
    func setupConstraints(){
        NSLayoutConstraint.activate([
            ...
            beneficiaryNameLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 30),
            ...
            amountLabel.topAnchor.constraint(equalTo: beneficiaryNameLabel.bottomAnchor, constant: 30),
            ...
            accountNumberLabel.topAnchor.constraint(equalTo: amountLabel.bottomAnchor, constant: 30),
            ...
            sortCodeLabel.topAnchor.constraint(equalTo: accountNumberLabel.bottomAnchor, constant: 30),
            ...
            referenceNumberLabel.topAnchor.constraint(equalTo: sortCodeLabel.bottomAnchor, constant: 30),
            ...
            accountContinueButton.topAnchor.constraint(equalTo: referenceNumberValue.bottomAnchor, constant: 50),
