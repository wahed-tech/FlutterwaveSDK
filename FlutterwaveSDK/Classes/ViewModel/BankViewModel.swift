...
class BankViewModel: BaseViewModel{
    ...
    func ukAccountTransfer(amount: String, accountBank: String, accountNumber: String) {
        let request = UKAccountPaymentsRequest(txRef: FlutterwaveConfig.sharedConfig().transcationRef, amount: amount, accountBank: accountBank, accountNumber:accountNumber, currency: FlutterwaveConfig.sharedConfig().currencyCode, email: FlutterwaveConfig.sharedConfig().email, phoneNumber: FlutterwaveConfig.sharedConfig().phoneNumber, fullname: "\(FlutterwaveConfig.sharedConfig().firstName.orEmpty()) \(FlutterwaveConfig.sharedConfig().lastName.orEmpty())")
    ...
    func nigeriaBankTransfer(amount: String, accountBank: String, accountNumber: String, phoneNumber: String, passCode:String, bvn:String) {
        let request = NigeriaBankTransferRequest(txRef: FlutterwaveConfig.sharedConfig().transcationRef, amount: amount, accountBank: accountBank, accountNumber: accountNumber, currency: FlutterwaveConfig.sharedConfig().currencyCode, email: FlutterwaveConfig.sharedConfig().email, phoneNumber: phoneNumber, passCode:passCode, bvn:bvn, fullname: "\(FlutterwaveConfig.sharedConfig().firstName.orEmpty()) \(FlutterwaveConfig.sharedConfig().lastName.orEmpty())")
    ...
    func ussd(amount: String,ussdBank:USSDBanks?) {
        let request = USSDRequest(txRef: FlutterwaveConfig.sharedConfig().transcationRef, accountBank: ussdBank?.bankCode, amount: amount, currency: FlutterwaveConfig.sharedConfig().currencyCode, email: FlutterwaveConfig.sharedConfig().email, phoneNumber: FlutterwaveConfig.sharedConfig().phoneNumber, fullname: "\(FlutterwaveConfig.sharedConfig().firstName.orEmpty()) \(FlutterwaveConfig.sharedConfig().lastName.orEmpty())")
